...
/*
    ...
    the JSlack API to describe values in dropdowns, radio buttons, and
    ...
    JSlack server in `page_params`, so that the data is available for
...
export const notification_settings_labels = {
    ...
    enable_marketing_emails: $t({
        defaultMessage: "Send me JSlack's low-traffic newsletter (a few emails a year)",
    }),
...
export const all_group_setting_labels = {
    realm: {
        ...
        can_create_write_only_bots_group: $t({
            defaultMessage: "Who can create bots that send messages into JSlack",
        }),
